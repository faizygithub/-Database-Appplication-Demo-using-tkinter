...
def search_command():
    list1.delete(0,END)
    for row in backend.search(tittle_text.get(),auther_text.get(),year_text.get(),isbn_text.get()):
        list1.insert(END,row)
def add_command():
    backend.insert(tittle_text.get(),auther_text.get(),year_text.get(),isbn_text.get())
    list1.delete(0,END)
...
def update_command():
    backend.update(selected_touple[0],tittle_text.get(),auther_text.get(),year_text.get(),isbn_text.get())
